...
- `scripts/docker-prod.sh` — validates and operates the production Docker Compose stack; `up` automatically gates backend startup on the one-shot Prisma migration.
