...
15. [P2 — rebrand（"香港01" → "LC 传媒"）文案一致性](#15-p2--rebrand香港01--lc-传媒文案一致性)
...
## 15. P2 — rebrand（"香港01" → "LC 传媒"）文案一致性
...
|------|------|
| **优先级** | P0 |
| **测试步骤** | grep "香港01" 在 `frontend/src/` 和 `backend/src/` |
...
|------|------|
| **优先级** | P2 |
| **测试步骤** | grep "香港01" 在 `docs/` 和 `README.md` |
...
|------|------|
| **优先级** | P1 |
| **测试步骤** | grep "香港01" 在 `backend/src/**/*.ts` |
...
|------|------|
| **优先级** | P1 |
| **测试数据** | 选题标题"突发：香港 01 调查：AI 深度伪造技术的最新进展" |
