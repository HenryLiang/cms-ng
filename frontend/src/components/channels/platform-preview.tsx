...
import { Globe, Share2, Camera, MessageSquare, MessageCircle, MonitorSmartphone, BookOpen, Play, Bell, Copy, Check, ExternalLink, RefreshCw, Trash2, Loader2 } from 'lucide-react';
...
export default function PlatformPreview({ publish, onRegenerate, onDelete, onMarkPublished, regenerating }: PlatformPreviewProps) {
